...
trees_and_asthma_ed_adult |> 
  plot_ly(data = _, x = ~trees_per_acre, y = ~average_annual_age_adjusted_rate_per_10_000,
          text = ~paste("neighborhood: ", nta_name, "<br>borough: ", borough, "<br>tree per acre: ", trees_per_acre, "<br>rate of adult asthma ED visits: ", average_annual_age_adjusted_rate_per_10_000),
          color = ~nta_name) |> 
...
trees_and_asthma_ed_adult |> 
  plot_ly(data = _, x = ~trees_per_acre, y = ~average_annual_rate_per_10_000,
          text = ~paste("neighborhood: ", nta_name, "<br>borough: ", borough, "<br>tree per acre: ", trees_per_acre, "<br>rate of adult asthma ED visits: ", average_annual_rate_per_10_000),
          color = ~nta_name) |> 
    layout(title = "Trees per acre and rate of adult asthma ED visits by neighborhood")
...
trees_and_asthma_ed_adult |> 
  plot_ly(data = _, x = ~num_trees, y = ~average_annual_age_adjusted_rate_per_10_000,
          text = ~paste("neighborhood: ", nta_name, "<br>borough: ", borough, "<br>number of trees: ", num_trees, "<br>rate of adult asthma ED visits: ", average_annual_age_adjusted_rate_per_10_000),
          color = ~nta_name) |> 
...
trees_and_asthma_ed_adult |> 
  plot_ly(data = _, x = ~num_trees, y = ~average_annual_rate_per_10_000,
          text = ~paste("neighborhood: ", nta_name, "<br>borough: ", borough, "<br>number of trees: ", num_trees, "<br>rate of adult asthma ED visits: ", average_annual_rate_per_10_000),
          color = ~nta_name) |> 
    layout(title = "Number of trees and rate of adult asthma ED visits by neighborhood")
...
trees_and_asthma_hosp_adult |> 
  plot_ly(data = _, x = ~trees_per_acre, y = ~average_annual_age_adjusted_rate_per_10_000,
          text = ~paste("neighborhood: ", nta_name, "<br>borough: ", borough, "<br>tree per acre: ", trees_per_acre, "<br>rate of adult asthma hospitalizations: ", average_annual_age_adjusted_rate_per_10_000),
          color = ~nta_name) |> 
...
trees_and_asthma_hosp_adult |> 
  plot_ly(data = _, x = ~trees_per_acre, y = ~average_annual_rate_per_10_000,
          text = ~paste("neighborhood: ", nta_name, "<br>borough: ", borough, "<br>tree per acre: ", trees_per_acre, "<br>rate of adult asthma hospitalizations: ", average_annual_rate_per_10_000),
          color = ~nta_name) |> 
    layout(title = "Trees per acre and rate of adult asthma hospitalizations by neighborhood")
...
trees_and_asthma_hosp_adult |> 
  plot_ly(data = _, x = ~num_trees, y = ~average_annual_age_adjusted_rate_per_10_000,
          text = ~paste("neighborhood: ", nta_name, "<br>borough: ", borough, "<br>number of trees: ", num_trees, "<br>rate of adult asthma hospitalizations: ", average_annual_age_adjusted_rate_per_10_000),
          color = ~nta_name) |> 
...
trees_and_asthma_hosp_adult |> 
  plot_ly(data = _, x = ~num_trees, y = ~average_annual_rate_per_10_000,
          text = ~paste("neighborhood: ", nta_name, "<br>borough: ", borough, "<br>number of trees: ", num_trees, "<br>rate of adult asthma hospitalizations: ", average_annual_rate_per_10_000),
          color = ~nta_name) |> 
    layout(title = "Number of trees and rate of adult asthma hospitalizations by neighborhood")
...
```{r}
trees_and_poverty |> 
  plot_ly(data = _, x = ~trees_per_acre, y = ~poverty_percent,
          text = ~paste("neighborhood: ", nta_name, "<br>borough: ", borough, "<br>trees per acre: ", trees_per_acre, "<br>%people whose income is below poverty line: ", poverty_percent),
          color = ~nta_name) |> 
...
trees_and_poverty |> 
  plot_ly(data = _, x = ~num_trees, y = ~poverty_percent,
          text = ~paste("neighborhood: ", nta_name, "<br>borough: ", borough, "<br>number of trees: ", num_trees, "<br>%people whose income is below poverty line: ", poverty_percent),
          color = ~nta_name) |> 
