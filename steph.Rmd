...
trees_and_asthma_ed_adult |> 
  select(nta_name, borough, num_trees, total_acres, trees_per_acre, average_annual_age_adjusted_rate_per_10_000) |> 
  arrange(desc(trees_per_acre)) |> 
...
trees_and_asthma_ed_adult |> 
  plot_ly(data = _, x = ~average_annual_age_adjusted_rate_per_10_000, y = ~ trees_per_acre,
          text = ~paste("neighborhood: ", nta_name, "<br>borough: ", borough, "<br>rate of adult asthma ED visits: ", average_annual_age_adjusted_rate_per_10_000, "<br>tree per acre: ", trees_per_acre),
          color = ~nta_name) |> 
  layout(title = "Trees per acre and rate of adult asthma ED visits by neighborhood")
...
trees_and_asthma_ed_adult |> 
  plot_ly(data = _, x = ~average_annual_rate_per_10_000, y = ~ trees_per_acre,
          text = ~paste("neighborhood: ", nta_name, "<br>borough: ", borough, "<br>rate of adult asthma ED visits: ", average_annual_rate_per_10_000, "<br>tree per acre: ", trees_per_acre),
          color = ~nta_name) |> 
    layout(title = "Trees per acre and rate of adult asthma ED visits by neighborhood")
...
trees_and_asthma_ed_adult |> 
  plot_ly(data = _, x = ~average_annual_age_adjusted_rate_per_10_000, y = ~num_trees,
          text = ~paste("neighborhood: ", nta_name, "<br>borough: ", borough, "<br>rate of adult asthma ED visits: ", average_annual_age_adjusted_rate_per_10_000, "<br>number of trees: ", num_trees),
          color = ~nta_name) |> 
    layout(title = "Number of trees and rate of adult asthma ED visits by neighborhood")

cor(pull(trees_and_asthma_ed_adult, num_trees), pull(trees_and_asthma_ed_adult, average_annual_age_adjusted_rate_per_10_000))

trees_and_asthma_ed_adult |> 
  plot_ly(data = _, x = ~average_annual_rate_per_10_000, y = ~num_trees,
          text = ~paste("neighborhood: ", nta_name, "<br>borough: ", borough, "<br>rate of adult asthma ED visits: ", average_annual_rate_per_10_000, "<br>number of trees: ", num_trees),
          color = ~nta_name) |> 
    layout(title = "Number of trees and rate of adult asthma ED visits by neighborhood")
...
trees_and_asthma_hosp_adult |> 
  plot_ly(data = _, x = ~average_annual_age_adjusted_rate_per_10_000, y = ~trees_per_acre, color = ~nta_name, type = "scatter",
          text = ~paste("neighborhood: ", nta_name, "<br>borough: ", borough, "<br>rate of adult asthma hospitalizations: ", average_annual_age_adjusted_rate_per_10_000, "<br>tree per acre: ", trees_per_acre)) |> 
  layout(title = "Trees per acre and rate of adult asthma hospitalizations by neighborhood")
...
trees_and_asthma_hosp_adult |> 
  plot_ly(data = _, x = ~average_annual_rate_per_10_000, y = ~trees_per_acre, color = ~nta_name, type = "scatter",
          text = ~paste("neighborhood: ", nta_name, "<br>borough: ", borough, "<br>rate of adult asthma hospitalizations: ", average_annual_rate_per_10_000, "<br>tree per acre: ", trees_per_acre)) |> 
    layout(title = "Trees per acre and rate of adult asthma hospitalizations by neighborhood")

cor(pull(trees_and_asthma_hosp_adult, trees_per_acre), pull(trees_and_asthma_hosp_adult, average_annual_rate_per_10_000))

trees_and_asthma_hosp_adult |> 
  plot_ly(data = _, x = ~average_annual_age_adjusted_rate_per_10_000, y = ~num_trees, color = ~nta_name, type = "scatter",
          text = ~paste("neighborhood: ", nta_name, "<br>borough: ", borough, "<br>rate of adult asthma hospitalizations: ", average_annual_age_adjusted_rate_per_10_000, "<br>number of trees: ", num_trees)) |> 
    layout(title = "Number of trees and rate of adult asthma hospitalizations by neighborhood")
...
trees_and_asthma_hosp_adult |> 
  plot_ly(data = _, x = ~average_annual_rate_per_10_000, y = ~num_trees, color = ~nta_name, type = "scatter",
          text = ~paste("neighborhood: ", nta_name, "<br>borough: ", borough, "<br>rate of adult asthma hospitalizations: ", average_annual_rate_per_10_000, "<br>number of trees: ", num_trees)) |> 
    layout(title = "Number of trees and rate of adult asthma hospitalizations by neighborhood")
...
```{r}
trees_and_poverty |> 
  plot_ly(data = _, x = ~poverty_percent, y = ~trees_per_acre, color = ~nta_name, type = "scatter",
          text = ~paste("neighborhood: ", nta_name, "<br>borough: ", borough, "<br>%people whose income is below 
                        poverty line: ", poverty_percent, "<br>trees per acre: ", trees_per_acre)) |> 
    layout(title = "Trees per acre and percentage of poverty by neighborhood")


cor(pull(trees_and_poverty, trees_per_acre), pull(trees_and_poverty, poverty_percent))

trees_and_poverty |> 
  plot_ly(data = _, x = ~poverty_percent, y = ~num_trees, color = ~nta_name, type = "scatter",
          text = ~paste("neighborhood: ", nta_name, "<br>borough: ", borough, "<br>%people whose income is below 
                        poverty line: ", poverty_percent, "<br>number of trees: ", num_trees)) |> 
    layout(title = "Number of trees and percentage of poverty by neighborhood")
...
```{r}
trees_and_education |> 
  plot_ly(data = _, x = ~graduated_hs_percent, y = ~trees_per_acre, color = ~nta_name, type = "scatter",
    ...
    layout(title = "Trees per acre and percentage of people who graduated HS by neighborhood")
