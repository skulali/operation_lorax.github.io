...
scale_colour_discrete = scale_colour_viridis_d(option = "mako")
scale_fill_discrete = scale_fill_viridis_d(option = "mako")
```
...
trees_zip |> 
  ...
  tm_polygons(col = "health",
              ...
              border.col = "black",
              title = "Tree Health Status")+
  tm_layout(main.title = "Tree Heath by Zip Codes in Manhattan",
            main.title.size = 1,
            frame = FALSE) +
  tm_legend(legend.position = c("left","center"),
            legend.text.size = 0.52)
...
trees_nta |> 
  ...
  tm_polygons(col = "health",
              ...
              border.col = "black",
              title = "Tree Health Status")+
  tm_layout(main.title = "Tree Heath by Zip Codes in Washington Heights",
            main.title.size = 1,
            frame = FALSE) +
  tm_legend(legend.position = c("left","center"),
            legend.text.size = 0.52)
